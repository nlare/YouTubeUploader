...
public class HTMLParser  {
    ...
    private static int delay_in_min;
    ...
    public static void main(String[] args)  {
        ...
        try {
            ...
            if(name_of_profile == null) {
                ...
                System.out.println("Program get out!");
                System.exit(1);
        ...
        try {
            ...
            for(Element el: imgElements)  {
                ...
                try {
                    ...
                    System.out.println("Downloading video: " + imgAttrVideo[count] + " -> ./tmp/" + imgAttrName[count].replace(" ", "_") + ".mp4");
                ...
                if(DELAY_FOR_UPLOAD)    {
                    ...
                    Thread.sleep(delay_in_min*1000*60);
    ...
    System.out.println(GREEN_COLOR + "The End of Uploading! Press any key to exit.\n");
    try {
        System.in.read();
    }   catch(Exception e)  {
        e.printStackTrace();
